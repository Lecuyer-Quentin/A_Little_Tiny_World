...
<article>
    <div class="d-flex justify-content-between align-items-center">
        <h2>Roles</h2>
        <a href="<?php echo RACINE_SITE; ?>index.php?page=admin&section=roles&action=add" class="btn btn-success">
            Ajouter un role
        </a>
    </div>
            ...
            <?php
                foreach($roles as $role){
                    ...
                    $row = "<tr>";
                        ...
                        $row .= "<td>$nom</td>";
                        $row .= "<td class='d-flex'>";
                            $row .= "<a href='". RACINE_SITE ."index.php?page=admin&section=roles&action=edit&id=$id' class='btn btn-primary'>Edit</a>";
