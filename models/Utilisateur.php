...
class Utilisateur
{
    ...
    public function __construct ($id, $nom, $prenom, $email, $mot_de_passe, Role $role, $date_inscription, $isActif, $token, 
                                    $numRue=null, $nomRue=null, $ville=null, $codePostal=null, $pays=null, $telephone=null, $avatar=null)
    {
        ...
        $this->set_value_of('telephone', $telephone);
    ...
    public function get_value_of($attribut)
    {
        if(property_exists($this, $attribut)){
            if($attribut == 'avatar'){
                return 'images/users/' . $this->$attribut;
            }
