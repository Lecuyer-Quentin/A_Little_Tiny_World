...

{
    ...
    private function query_update(){
        ...
        $query .= 'SET nom = :nom, description = :description, prix = :prix, inStock = :inStock, image = :image';
        $query .= ' WHERE id = :id';
        return $query;
    }  
    // ----------- \\
    ...
    {
        $stmt = $this->pdo->prepare($this->query_select() . ' WHERE pc.fkIdCategorie = :categorie_id');
    ...
    public function delete (int $id)
    {
        try{
            ...
            $stmt = $this->pdo->prepare('DELETE FROM produit_categorie WHERE fkIdProduit = :id');
            $stmt->bindParam(':id', $id, PDO::PARAM_INT);
            $stmt->execute();
            $stmt->closeCursor();

            $stmt = $this->pdo->prepare('DELETE FROM produit_special WHERE fkIdProduit = :id');
            $stmt->bindParam(':id', $id, PDO::PARAM_INT);
            $stmt->execute();
            $stmt->closeCursor();
    ...
    public function update (int $id, array $data){
        try{
            $this->pdo->beginTransaction();
            $stmt = $this->pdo->prepare($this->query_update());
            $stmt->bindParam(':id', $id, PDO::PARAM_INT);
            $stmt->bindParam(':nom', $data['nom'], PDO::PARAM_STR);
            $stmt->bindParam(':description', $data['description'], PDO::PARAM_STR);
            $stmt->bindParam(':prix', $data['prix'], PDO::PARAM_STR);
           ...
           $stmt = $this->pdo->prepare('UPDATE produit_categorie SET fkIdCategorie = :fkIdCategorie WHERE fkIdProduit = :fkIdProduit');
           $stmt->bindParam(':fkIdProduit', $id, PDO::PARAM_INT);
           $stmt->bindValue(':fkIdCategorie', $data['categorie'], PDO::PARAM_INT);
           $stmt->execute();
           $stmt->closeCursor();

           $stmt = $this->pdo->prepare('UPDATE produit_special SET fkIdSpecial = :fkIdSpecial WHERE fkIdProduit = :fkIdProduit');
           $stmt->bindParam(':fkIdProduit', $id, PDO::PARAM_INT);
           $stmt->bindValue(':fkIdSpecial', $data['special'], PDO::PARAM_INT);
           $stmt->execute();
           $stmt->closeCursor();
